...
class PhysicsInformedNN:
    ...
    def __init__(self, x, z, sx, fre, u0_real, u0_imag, m, m0, layers):
       ...
       # Initialize NN
        ...
        self.sess.run(init)
        self.saver.restore(self.sess,'./checkpoint_dir/Mymodel_ff_two32_004') # model save
...
if __name__ == "__main__": 
    ...
    train_data = scipy.io.loadmat('sigsbee_train_data_fre_N50000_f510_v1.mat')
    ...
    scipy.io.savemat('misfit_fre_two32_from5_ff_uniform_xavier1_v1.mat',{'misfit':misfit})
    scipy.io.savemat('misfit1_fre_two32_from5_ff_uniform_xavier1_v1.mat',{'misfit1':misfit1})
    

    N = x_star.shape[0]
    frequency_band = range(2,13)
    ...
    for fre in frequency_band:
        ...
        scipy.io.savemat('du_real_pred_atan_%dhz_fre_two32_from5_ff_uniform_xavier1_v1.mat'%(fre),{'du_real_pred':du_real_pred})
        scipy.io.savemat('du_imag_pred_atan_%dhz_fre_two32_from5_ff_uniform_xavier1_v1.mat'%(fre),{'du_imag_pred':du_imag_pred})
